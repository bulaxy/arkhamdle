...
import type { GuessCardByTraitSettings } from "../../types";

interface GuessCardByTraitSectionProps {
  isOpen: boolean;
  onToggle: () => void;
  ...
  packs: string[];
  settings: GuessCardByTraitSettings;
  onChange: (settings: GuessCardByTraitSettings) => void;
}

export default function GuessCardByTraitSection({
  isOpen,
  onToggle,
  inputMode,
  onInputModeChange,
